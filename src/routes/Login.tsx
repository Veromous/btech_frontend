            ...
            <div className="hidden lg:flex flex-col justify-between w-1/2 bg-black text-white px-14 py-12">
                ...
                <div>
                    <h2 className="text-4xl font-bold leading-snug mb-4">
                        Your research,<br />powered by data.
                    </h2>
                    <p className="text-gray-400 text-base leading-relaxed max-w-sm">
                        Access thousands of curated datasets — organised, searchable,
                        and always up to date. Built for researchers who move fast.
                    </p>
                </div>
            ...
            <div className="flex flex-1 flex-col items-center justify-center px-8 py-12 bg-white">
                <div className="w-full max-w-sm">
                    ...
                    <p className="text-sm text-gray-400 mb-8">
                        ...
                        <Link to="/signup" className="text-black font-semibold underline underline-offset-2">
                            Sign up
                        </Link>
                    </p>
